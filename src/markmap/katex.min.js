    ...
    function(t, e, r) {
      ...
      var z = {
        ...
        q = function(t) {
          ...
          for (var n in (r && (e += ' style="' + c.escape(r) + '"'), this.attributes))
            this.attributes.hasOwnProperty(n) && (e += ' ' + n + '="' + c.escape(this.attributes[n]) + '"');
          e += '>';
        ...
        E = (function() {
          function t(t, e, r, a, n, i, o, s) {
            ...
            l && this.classes.push(l + '_fallback'), /[\xee\xef\xed\xec]/.test(this.text) && (this.text = R[this.text]);
          }
          var e = t.prototype;
          return (
            (e.hasClass = function(t) {
            ...
            (e.toMarkup = function() {
              ...
              for (var a in (this.italic > 0 && (r += 'margin-right:' + this.italic + 'em;'), this.style))
                this.style.hasOwnProperty(a) && (r += c.hyphenate(a) + ':' + this.style[a] + ';');
      ...
      function G(t, e, r) {
        ...
        var a = t.charCodeAt(0),
          n = F[e][a];
        if ((!n && t[0] in U && ((a = U[t[0]].charCodeAt(0)), (n = F[e][a])), n || 'text' !== r || (M(a) && (n = F[e][77])), n))
      ...
      var St = kt,
          ...
          tryCombineChars: function(t) {
            for (var e = 0; e < t.length - 1; e++) {
              ...
              r instanceof E &&
                a instanceof E &&
                qt(r, a) &&
                ((r.text += a.text), (r.height = Math.max(r.height, a.height)), (r.depth = Math.max(r.depth, a.depth)), (r.italic = a.italic), t.splice(e + 1, 1), e--);
            }
            return t;
          },
        },
        ...
        Ut = {
          ...
          minner: { mord: Ht, mop: Ht, mbin: Ft, mrel: Vt, mopen: Ht, mpunct: Ht, minner: Ht },
        },
        Gt = { mord: { mop: Ht }, mop: { mord: Ht, mop: Ht }, mbin: {}, mrel: {}, mopen: {}, mclose: { mop: Ht }, mpunct: {}, minner: { mop: Ht } },
        Yt = {},
        Wt = {},
        Xt = {};
      function _t(t) {
      ...
      var $t = function(t) {
        ...
        Qt = { display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT },
        ...
        re = function t(e, r, a, n, i) {
          ...
          for (var o = 0; o < e.length; o++) {
            ...
            if (l) t(l.children, r, a, null, i);
              ...
              h ? (a.node = s) : i && s.hasClass('newline') && (a.node = Zt(['leftmost'])),
      ...
      var me = (function() {
        ...
        pe = function(t, e, r) {
          return (
            !j[e][t] ||
              ...
              (rt.hasOwnProperty(t) && r && ((r.fontFamily && 'tt' === r.fontFamily.substr(4, 2)) || (r.font && 'tt' === r.font.substr(4, 2)))) ||
              (t = j[e][t].replace),
            new ue.TextNode(t)
          );
        },
        ...
        fe = function(t, e) {
          ...
          return c.contains(['\\imath', '\\jmath'], n)
            ? null
            : (j[a][n] && j[a][n].replace && (n = j[a][n].replace), G(n, Dt.fontMap[r].fontName, a) ? Dt.fontMap[r].variant : null);
        },
        ge = function(t, e, r) {
          if (1 === t.length) {
            var a = ve(t[0], e);
      ...
      var ye = function(t) {
        ...
        Ae = function(t, e, r, a) {
          ...
          if (/fbox|color/.test(e)) {
            ...
            var s = [];
            /^[bx]cancel$/.test(e) && s.push(new D({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
              /^x?cancel$/.test(e) && s.push(new D({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' }));
              ...
              if (c.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], a)) {
                ...
                if (s > 5) 'widehat' === a || 'widecheck' === a ? ((n = 420), (r = 2364), (o = 0.42), (i = a + '4')) : ((n = 312), (r = 2340), (o = 0.34), (i = 'tilde4'));
                  ...
                  'widehat' === a || 'widecheck' === a
                    ? ((r = [0, 1062, 2364, 2364, 2364][l]), (n = [0, 239, 300, 360, 420][l]), (o = [0, 0.24, 0.3, 0.3, 0.36, 0.42][l]), (i = a + l))
                    : ((r = [0, 600, 1033, 2339, 2340][l]), (n = [0, 260, 286, 306, 312][l]), (o = [0, 0.26, 0.286, 0.3, 0.306, 0.34][l]), (i = 'tilde' + l));
                }
                var h = new P(i),
                  m = new L([h], { width: '100%', height: o + 'em', viewBox: '0 0 ' + r + ' ' + n, preserveAspectRatio: 'none' });
      ...
      var Ie = function(t, e) {
          ...
          if (a.isStretchy)
              ...
              (l = Dt.makeVList(
                {
                  ...
                  children: [
                    { type: 'elem', elem: i },
                    { type: 'elem', elem: l, wrapperClasses: ['svg-align'], wrapperStyle: o > 0 ? { width: 'calc(100% - ' + 2 * o + 'em)', marginLeft: 2 * o + 'em' } : void 0 },
                  ],
                },
                e
              ));
            ...
            '\\vec' === a.label
              ...
              : (((m = H((m = Dt.makeOrd({ mode: a.mode, text: a.label }, e, 'textord')))).italic = 0), (u = m.width)),
      ...
      _t({
        ...
        htmlBuilder: function(t, e) {
          ...
          if (((i.depth > 0.25 || '\\xleftequilibrium' === t.label) && (h -= i.depth), r)) {
        ...
        _t({
          ...
          handler: function(t, e, r) {
            ...
            return (
              ...
              { type: 'cr', mode: a.mode, newLine: s, newRow: o, size: i && Ce(i, 'size').value }
            );
          },
          htmlBuilder: function(t, e) {
      ...
      var De = {
        ...
        Fe = function(t, e, r, a) {
          ...
          null == n && ((r.noexpand = !0), (n = { tokens: [r], numArgs: 0, unexpandable: !t.gullet.isExpandable(r.text) })), t.gullet.macros.set(e, n, a);
        };
      _t({
        type: 'internal',
        ...
        _t({
          ...
          handler: function(t) {
            ...
            return (
              ('\\edef' !== r && '\\xdef' !== r) || (a = e.gullet.expandTokens(a)).reverse(),
        ...
        _t({
          ...
          handler: function(t) {
            ...
            return Fe(e, a, n, '\\\\globallet' === r), { type: 'internal', mode: e.mode };
          },
        }),
        _t({
          type: 'internal',
          ...
          handler: function(t) {
            var e = t.parser,
              ...
              n = e.gullet.popToken(),
              i = e.gullet.popToken();
            return Fe(e, a, i, '\\\\globalfuture' === r), e.gullet.pushToken(i), e.gullet.pushToken(n), { type: 'internal', mode: e.mode };
          },
        });
      var Ve = function(t, e, r) {
        ...
        We = function(t, e, r) {
          var a;
          return (
            (a = 'Size1-Regular' === e ? 'delim-size1' : 'delim-size4'), { type: 'elem', elem: Dt.makeSpan(['delimsizinginner', a], [Dt.makeSpan([], [Dt.makeSymbol(t, e, r)])]) }
          );
        },
        ...
        _e = function(t, e, r, a, n, i) {
          ...
          '\\uparrow' === t
            ...
            : '\\lmoustache' === t || '\u23b0' === t
            ? ((o = '\u23a7'), (h = '\u23ad'), (l = '\u23aa'), (m = 'Size4-Regular'))
            : ('\\rmoustache' !== t && '\u23b1' !== t) || ((o = '\u23ab'), (h = '\u23a9'), (l = '\u23aa'), (m = 'Size4-Regular'));
          var c = Ve(o, m, n),
            u = c.height + c.depth,
            p = Ve(l, m, n),
            d = p.height + p.depth,
          ...
          var z = S / 2 - M,
            A = 0.005 * (k + 1) - d,
            T = [];
          if ((T.push(We(h, m, n)), null === s)) for (var B = 0; B < k; B++) T.push(Xe), T.push(We(l, m, n));
          else {
            for (var C = 0; C < k; C++) T.push(Xe), T.push(We(l, m, n));
            T.push({ type: 'kern', size: A }), T.push(We(l, m, n)), T.push(Xe), T.push(We(s, m, n));
            for (var q = 0; q < k; q++) T.push(Xe), T.push(We(l, m, n));
          }
          if (('\u239c' !== l && '\u239f' !== l) || 0 !== k) T.push({ type: 'kern', size: A }), T.push(We(l, m, n)), T.push(Xe);
          else {
            var N = Dt.svgData.leftParenInner[2] / 2;
            T.push({ type: 'kern', size: -N });
            var I = '\u239c' === l ? 'leftParenInner' : 'rightParenInner',
              O = Dt.staticSvg(I, a);
            T.push({ type: 'elem', elem: O }), T.push({ type: 'kern', size: -N });
          }
          T.push(We(o, m, n));
          var R = a.havingBaseStyle(w.TEXT),
            E = Dt.makeVList({ positionType: 'bottom', positionData: z, children: T }, R);
        ...
        ir = function(t, e) {
          ...
          return (
            'small' === i.type
              ? (t < 1 ? (o = 1) : t < 1.4 && (o = 0.7),
                (h = (1 + s) / o),
                ((r = je('sqrtMain', (l = (1 + s + 0.08) / o), (m = 1e3 + 1e3 * s + 80), s, e)).style.minWidth = '0.853em'),
                (a = 0.833 / o))
              : 'large' === i.type
              ? ((m = 1080 * Je[i.size]),
                (h = (Je[i.size] + s) / o),
                (l = (Je[i.size] + s + 0.08) / o),
                ((r = je('sqrtSize' + i.size, l, m, s, e)).style.minWidth = '1.02em'),
                (a = 1 / o))
              : ((l = t + s + 0.08), (h = t + s), (m = Math.floor(1e3 * t + s) + 80), ((r = je('sqrtTall', l, m, s, e)).style.minWidth = '0.742em'), (a = 1.056)),
            (r.height = h),
            (r.style.height = l + 'em'),
      ...
      _t({
        ...
        handler: function(t, e) {
          var r = cr(e[0], t);
          return { type: 'delimsizing', mode: t.parser.mode, size: hr[t.funcName].size, mclass: hr[t.funcName].mclass, delim: r.text };
        },
        htmlBuilder: function(t, e) {
        ...
        _t({
          ...
          htmlBuilder: function(t, e) {
            ur(t);
            for (var r, a, n = ee(t.body, e, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, l = 0; l < n.length; l++)
      ...
      var pr = function(t, e) {
          ...
          if ('sout' === i) ((r = Dt.makeSpan(['stretchy', 'sout'])).height = e.fontMetrics().defaultRuleThickness / o), (s = -0.5 * e.fontMetrics().xHeight);
            ...
            var h = 0,
              m = 0;
            /box/.test(i) ? ((m = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)), (h = e.fontMetrics().fboxsep + ('colorbox' === i ? 0 : m))) : (h = l ? 0.2 : 0),
              (r = Ae(n, i, h, e)),
          ...
          return (
            ...
            /cancel/.test(i) && !l ? Dt.makeSpan(['mord', 'cancel-lap'], [a], e) : Dt.makeSpan(['mord'], [a], e)
          );
        },
        dr = function(t, e) {
          var r = 0,
      ...
      function gr(t) {
        for (
          var e = t.type,
            ...
            i = t.htmlBuilder,
            o = t.mathmlBuilder,
            s = { type: e, numArgs: a.numArgs || 0, greediness: 1, allowedInText: !1, numOptionalArgs: 0, handler: n },
            l = 0;
          l < r.length;
          ++l
        )
      ...
      function vr(t, e, r) {
        ...
        return (
          t.gullet.endGroup(),
          t.gullet.endGroup(),
          { type: 'array', mode: t.mode, addJot: n, arraystretch: s, body: c, cols: i, rowGaps: u, hskipBeforeAndAfter: a, hLinesBeforeRow: p, colSeparationType: l }
        );
      }
      function br(t) {
      ...
      var yr = function(t, e) {
          ...
          var d = 12 * u,
            ...
            b = 0;
          function y(t) {
            for (var e = 0; e < t.length; ++e) e > 0 && (b += 0.25), h.push({ pos: b, isDashed: t[e] });
          }
          ...
          for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
            for (var R = I[q] || {}, E = !0; 'separator' === R.type; ) {
              if ((E || (((C = Dt.makeSpan(['arraycolsep'], [])).style.width = e.fontMetrics().doubleRuleSep + 'em'), O.push(C)), '|' !== R.separator && ':' !== R.separator))
            ...
            if (!(a >= s)) {
              ...
              for (r = 0; r < n; ++r) {
                ...
                if (V) {
                  var U = F.pos - N;
                  (V.depth = F.depth), (V.height = F.height), H.push({ type: 'elem', elem: V, shift: U });
                }
              }
              (H = Dt.makeVList({ positionType: 'individualShift', children: H }, e)),
                (H = Dt.makeSpan(['col-align-' + (R.align || 'c')], [H])),
                O.push(H),
                (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(R.postgap, p)) && (((C = Dt.makeSpan(['arraycolsep'], [])).style.width = D + 'em'), O.push(C));
            }
          }
          if (((l = Dt.makeSpan(['mtable'], O)), h.length > 0)) {
            for (var G = Dt.makeLineSpan('hline', e, m), Y = Dt.makeLineSpan('hdashline', e, m), W = [{ type: 'elem', elem: l, shift: 0 }]; h.length > 0; ) {
              var X = h.pop(),
                _ = X.pos - N;
              X.isDashed ? W.push({ type: 'elem', elem: Y, shift: _ }) : W.push({ type: 'elem', elem: G, shift: _ });
            }
            l = Dt.makeVList({ positionType: 'individualShift', children: W }, e);
          }
        ...
        kr = function(t, e) {
          ...
          if (t.cols && t.cols.length > 0) {
            ...
            for (var c = h; c < m; c++)
              'align' === o[c].type
                ...
                : 'separator' === o[c].type && l && ((s += '|' === o[c].separator ? 'solid ' : 'dashed '), (l = !1));
          ...
          return (
            ...
            '' !== n && (r = new ue.MathNode('menclose', [r])).setAttribute('notation', n.trim()),
        ...
        Sr = function(t, e) {
          ...
          for (var c = 0; c < i; ++c) {
            var u = 'r',
              p = 0;
            c % 2 == 1 ? (u = 'l') : c > 0 && m && (p = 1), (a[c] = { type: 'align', align: u, pregap: p, postgap: 0 });
          }
      ...
      function Tr(t, e) {
        ...
        return 'minner' === t.mclass
          ...
          : ('mord' === t.mclass
              ...
              : (t.isCharacterBox ? ((r = a[0]).type = 'mo') : (r = new ue.MathNode('mo', a)),
                'mbin' === t.mclass
      ...
      _t({
        ...
        handler: function(t, e) {
          var r = t.parser,
            a = t.funcName,
            n = e[0];
          return { type: 'mclass', mode: r.mode, mclass: 'm' + a.substr(5), body: $t(n), isCharacterBox: c.isCharacterBox(n) };
        },
        htmlBuilder: Ar,
        mathmlBuilder: Tr,
      });
      ...
      _t({
        ...
        _t({
          ...
          handler: function(t, e) {
            ...
            var s = { type: 'op', mode: i.mode, limits: !0, alwaysHandleSupSub: !0, parentIsSupSub: !1, symbol: !1, suppressBaseShift: '\\stackrel' !== n, body: $t(i) },
              l = { type: 'supsub', mode: o.mode, base: s, sup: '\\underset' === n ? null : o, sub: '\\underset' === n ? o : null };
            return { type: 'mclass', mode: a.mode, mclass: r, body: [l], isCharacterBox: c.isCharacterBox(l) };
          },
          htmlBuilder: Ar,
          mathmlBuilder: Tr,
        });
      ...
      var Ir = function(t, e) {
        ...
        Or = function(t, e) {
          ...
          if (
            (t.hasBarLine
              ? (t.barSize ? ((m = Tt(t.barSize, e)), (h = Dt.makeLineSpan('frac-line', e, m))) : (h = Dt.makeLineSpan('frac-line', e)), (m = h.height), (c = h.height))
              : ((h = null), (m = 0), (c = e.fontMetrics().defaultRuleThickness)),
          ...
          return (
            ...
            (x = null == t.leftDelim ? ie(e, ['mopen']) : sr(t.leftDelim, g, !0, e.havingStyle(a), t.mode, ['mopen'])),
            (v = t.continued ? Dt.makeSpan([]) : null == t.rightDelim ? ie(e, ['mclose']) : sr(t.rightDelim, g, !0, e.havingStyle(a), t.mode, ['mclose'])),
      ...
      _t({
        ...
        handler: function(t, e) {
          ...
          return { type: 'genfrac', mode: a.mode, continued: '\\cfrac' === n, numer: i, denom: o, hasBarLine: r, leftDelim: s, rightDelim: l, size: h, barSize: null };
        },
        htmlBuilder: Or,
        mathmlBuilder: Rr,
      }),
      ...
      _t({
        ...
        handler: function(t, e) {
          ...
          return { type: 'genfrac', mode: a.mode, numer: n, denom: i, continued: !1, hasBarLine: r, barSize: h, leftDelim: o, rightDelim: s, size: m };
        },
        htmlBuilder: Or,
        mathmlBuilder: Rr,
      }),
        _t({
          ...
          handler: function(t, e) {
            ...
            return { type: 'infix', mode: r.mode, replaceWith: '\\\\abovefrac', size: Ce(e[0], 'size').value, token: a };
          },
        }),
        _t({
          type: 'genfrac',
      ...
      var Pr = function(t, e) {
        var r,
          ...
          n = e.style;
        'supsub' === t.type
          ? ((r = t.sup ? oe(t.sup, e.havingStyle(n.sup()), e) : oe(t.sub, e.havingStyle(n.sub()), e)), (a = Ce(t.base, 'horizBrace')))
          : (a = Ce(t, 'horizBrace'));
        var i,
      ...
      _t({
        ...
        _t({
          ...
          handler: function(t, e) {
            var r = t.parser,
              a = e[1],
              n = Ce(e[0], 'url').url;
            return r.settings.isTrusted({ command: '\\href', url: n }) ? { type: 'href', mode: r.mode, href: n, body: $t(a) } : r.formatUnsupportedCmd('\\href');
          },
          htmlBuilder: function(t, e) {
            var r = ee(t.body, e, !1);
        ...
        _t({
          ...
          handler: function(t, e) {
            ...
            return a.settings.isTrusted(r) ? { type: 'html', mode: a.mode, attributes: l, body: $t(s) } : a.formatUnsupportedCmd(n);
          },
          htmlBuilder: function(t, e) {
            var r = ee(t.body, e, !1),
              a = ['enclosing'];
        ...
        _t({
          ...
          handler: function(t, e) {
            return { type: 'htmlmathml', mode: t.parser.mode, html: $t(e[0]), mathml: $t(e[1]) };
          },
          htmlBuilder: function(t, e) {
            var r = ee(t.html, e, !1);
            return Dt.makeFragment(r);
      ...
      _t({
        ...
        handler: function(t, e, r) {
          ...
          return (
            ...
            a.settings.isTrusted({ command: '\\includegraphics', url: p })
              ? { type: 'includegraphics', mode: a.mode, alt: l, width: n, height: i, totalheight: s, src: p }
        ...
        mathmlBuilder: function(t, e) {
          ...
          var a = Tt(t.height, e),
            n = 0;
          if (
            (t.totalheight.number > 0 && ((n = (n = Tt(t.totalheight, e) - a).toFixed(2)), r.setAttribute('valign', '-' + n + 'em')),
      ...
      _t({
        ...
        props: { numArgs: 4 },
        handler: function(t, e) {
          return { type: 'mathchoice', mode: t.parser.mode, display: $t(e[0]), text: $t(e[1]), script: $t(e[2]), scriptscript: $t(e[3]) };
        },
        htmlBuilder: function(t, e) {
          var r = Hr(t, e),
            a = ee(r, e, !1);
      ...
      var Fr = function(t, e, r, a, n, i, o) {
          ...
          if (((t = Dt.makeSpan([], [t])), e)) {
            ...
            l = { elem: m, kern: Math.max(a.fontMetrics().bigOpSpacing1, a.fontMetrics().bigOpSpacing3 - m.depth) };
          }
          if (r) {
        ...
        Ur = function(t, e) {
          ...
          if ((s.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0), n.symbol)) {
            var h = l ? 'Size2-Regular' : 'Size1-Regular',
              m = '';
            if (
              (('\\oiint' !== n.name && '\\oiiint' !== n.name) || ((m = n.name.substr(1)), (n.name = 'oiint' === m ? '\\iint' : '\\iiint')),
              (o = Dt.makeSymbol(n.name, h, 'math', e, ['mop', 'op-symbol', l ? 'large-op' : 'small-op'])),
              m.length > 0)
            ) {
              var u = o.italic,
          ...
          return (
            (o instanceof E || '\\oiint' === n.name || '\\oiiint' === n.name) &&
              !n.suppressBaseShift &&
              ((x = (o.height - o.depth) / 2 - e.fontMetrics().axisHeight), (v = o.italic)),
            i ? Fr(o, r, a, e, s, v, x) : (x && ((o.style.position = 'relative'), (o.style.top = x + 'em')), o)
          );
        },
        Gr = function(t, e) {
          var r;
      ...
      _t({
        ...
        _t({
          ...
          handler: function(t, e) {
            var r = t.parser,
              a = e[0];
            return { type: 'op', mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: $t(a) };
          },
          htmlBuilder: Ur,
          mathmlBuilder: Gr,
        });
      ...
      function _r(t, e, r) {
        for (var a = ee(t, e, !1), n = e.sizeMultiplier / r.sizeMultiplier, i = 0; i < a.length; i++) {
          ...
          o < 0 ? Array.prototype.push.apply(a[i].classes, e.sizingClasses(r)) : a[i].classes[o + 1] === 'reset-size' + e.size && (a[i].classes[o + 1] = 'reset-size' + r.size),
            (a[i].height *= n),
            (a[i].depth *= n);
        }
        return Dt.makeFragment(a);
      ...
      _t({
        ...
        handler: function(t, e) {
          var r = t.parser,
            a = t.funcName,
            n = e[0];
          return { type: 'operatorname', mode: r.mode, body: $t(n), alwaysHandleSupSub: '\\operatorname*' === a, limits: !1, parentIsSupSub: !1 };
        },
        htmlBuilder: Xr,
        mathmlBuilder: function(t, e) {
        ...
        _t({
          ...
          handler: function(t, e, r) {
            var a = t.parser,
              ...
              i = Ce(e[0], 'size'),
              o = Ce(e[1], 'size');
            return { type: 'rule', mode: a.mode, shift: n && Ce(n, 'size').value, width: i.value, height: o.value };
          },
          htmlBuilder: function(t, e) {
          ...
          mathmlBuilder: function(t, e) {
            ...
            return (
              n >= 0 ? s.setAttribute('height', '+' + n + 'em') : (s.setAttribute('height', n + 'em'), s.setAttribute('depth', '+' + -n + 'em')),
      ...
      jt({
        ...
        htmlBuilder: function(t, e) {
          ...
          if (a && n) {
            ...
            (u = Math.max(u, i, a.depth + 0.25 * m.xHeight)),
              (x = Dt.makeVList({ positionType: 'shift', positionData: -u, children: [{ type: 'elem', elem: a, marginRight: b }] }, e));
          }
        ...
        mathmlBuilder: function(t, e) {
          var r,
            a = !1;
          t.base && 'horizBrace' === t.base.type && !!t.sup === t.base.isOver && ((a = !0), (r = t.base.isOver)),
          ...
          if ((t.sub && i.push(ve(t.sub, e)), t.sup && i.push(ve(t.sup, e)), a)) n = r ? 'mover' : 'munder';
            ...
            if (t.sup) {
              ...
              n =
                o && 'op' === o.type && o.limits && e.style === w.DISPLAY
                  ? 'munderover'
                  : o && 'operatorname' === o.type && o.alwaysHandleSupSub && (e.style === w.DISPLAY || o.limits)
                  ? 'munderover'
                  : 'msubsup';
            } else {
              var s = t.base;
              n =
                s && 'op' === s.type && s.limits && (e.style === w.DISPLAY || s.alwaysHandleSupSub)
                  ? 'munder'
                  : s && 'operatorname' === s.type && s.alwaysHandleSupSub && (s.limits || e.style === w.DISPLAY)
                  ? 'munder'
                  : 'msub';
            }
          else {
            var l = t.base;
            n =
              l && 'op' === l.type && l.limits && (e.style === w.DISPLAY || l.alwaysHandleSupSub)
                ? 'mover'
                : l && 'operatorname' === l.type && l.alwaysHandleSupSub && (l.limits || e.style === w.DISPLAY)
                ? 'mover'
                : 'msup';
          }
      ...
      pa('\\noexpand', function(t) {
        var e = t.popToken();
        return t.isExpandable(e.text) && ((e.noexpand = !0), (e.treatAsRelax = !0)), { tokens: [e], numArgs: 0 };
      }),
      ...
      var fa = function(t, e, r) {
        ...
        if (1 === (a = t.consumeArgs(1)[0]).length && '[' === a[0].text) {
          for (var l = '', h = t.expandNextToken(); ']' !== h.text && 'EOF' !== h.text; ) (l += h.text), (h = t.expandNextToken());
      ...
      var va = F['Main-Regular']['T'.charCodeAt(0)][1] - 0.7 * F['Main-Regular']['A'.charCodeAt(0)][1] + 'em';
      pa('\\LaTeX', '\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{' + va + '}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}'),
        pa('\\KaTeX', '\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{' + va + '}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}'),
        ...
        pa('\u2983', '\\lBrace'),
        pa('\u2984', '\\rBrace'),
        pa('\\minuso', '\\mathbin{\\html@mathml{{\\mathrlap{\\mathchoice{\\kern{0.145em}}{\\kern{0.145em}}{\\kern{0.1015em}}{\\kern{0.0725em}}\\circ}{-}}}{\\char`\u29b5}}'),
        pa('\u29b5', '\\minuso'),
        pa('\\darr', '\\downarrow'),
        pa('\\dArr', '\\Downarrow'),
        pa('\\Darr', '\\Downarrow'),
          ...
          return (
            ...
            (e._getExpansion = function(t) {
              ...
              if ('string' == typeof r) {
                ...
                for (var i = new ha(r, this.settings), o = [], s = i.lex(); 'EOF' !== s.text; ) o.push(s), (s = i.lex());
        ...
        Sa = (function() {
          ...
          return (
            ...
            (e.handleInfixNodes = function(t) {
              ...
              if (-1 !== r && e) {
                var n,
                  ...
                  l = t.slice(r + 1);
                return (
                  (n = 1 === s.length && 'ordgroup' === s[0].type ? s[0] : { type: 'ordgroup', mode: this.mode, body: s }),
                  (i = 1 === l.length && 'ordgroup' === l[0].type ? l[0] : { type: 'ordgroup', mode: this.mode, body: l }),
            ...
            (e.parseAtom = function(t) {
              ...
              for (;;) {
                ...
                if ('\\limits' === n.text || '\\nolimits' === n.text) {
                  ...
                  '^' === this.fetch().text && h.push(this.handleSupSubscript('superscript')), (e = { type: 'ordgroup', mode: this.mode, body: h });
                }
              }
            ...
            (e.parseStringGroup = function(t, e, r) {
              ...
              for (var l, h = '', m = this.fetch(), c = 0, u = m; (l = this.fetch()).text !== n || (r && c > 0); ) {
                switch (l.text) {
                  case 'EOF':
            ...
            (e.parseSymbol = function() {
              ...
              if ((s && ('i' === (e = e.substring(0, s.index)) ? (e = '\u0131') : 'j' === e && (e = '\u0237')), j[this.mode][e])) {
                ...
                if (W.hasOwnProperty(h)) {
                  var c = h;
                  l = { type: 'atom', mode: this.mode, family: c, loc: m, text: e };
      ...
      (Sa.endOfExpression = ['}', '\\endgroup', '\\end', '\\right', '&']), (Sa.endOfGroup = { '[': ']', '{': '}', '\\begingroup': '\\endgroup' }), (Sa.SUPSUB_GREEDINESS = 1);
      var Ma = function(t, e) {
      ...
      var Aa = function(t, e, r) {
        ...
        Ba = {
          ...
          __defineSymbol: $,
          __defineMacro: pa,
          __domTree: { Span: N, Anchor: I, SymbolNode: E, SvgNode: L, PathNode: P, LineNode: D },
        };
      e.default = Ba;
    },
  ]).default;
